                ...
                <Card className="bg-gradient-card border-border h-fit">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      <span className="text-primary">security@bldr.app</span>
                    </p>
                  </CardContent>
                </Card>
              </div>
              ...
              <CardContent className="text-center">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <span className="text-primary ml-2">security@bldr.app</span>
                  </p>
                  <p>
                    <strong className="text-foreground">Telefone de Emergência:</strong> 
                    <span className="text-primary ml-2">+55 (11) 9999-9999</span>
                  </p>
                </div>
              </CardContent>
            </Card>
