      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-[#FFD700]/10 dark:bg-[#FFD700]/10 block  rounded-3xl"
          ...
          <Card>
            <div className="p-4 bg-zinc-900 rounded-full w-fit mb-4 border border-zinc-800">
                {item.icon}
            </div>
