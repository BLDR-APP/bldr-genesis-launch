...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[320px] md:max-w-[400px] -mt-24 md:-mt-80 mx-auto h-[650px] md:h-[850px] w-full border-[8px] border-[#4a4a4a] p-[6px] bg-[#222222] rounded-[55px] shadow-2xl relative"
    >
