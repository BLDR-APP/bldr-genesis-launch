...
// Importação necessária para o Aceternity UI
const {
...
export default {
    ...
    plugins: [
        ...
        addVariablesForColors, // Adicionado plugin essencial para Aceternity
    ],
} satisfies Config;

// Função necessária para os efeitos de brilho do Aceternity
